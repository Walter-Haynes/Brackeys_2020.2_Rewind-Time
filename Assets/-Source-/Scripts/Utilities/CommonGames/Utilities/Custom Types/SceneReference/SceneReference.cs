namespace CommonGames.Utilities.CGTK
{
    ...
    public sealed class SceneReference : ISerializationCallbackReceiver
    {
        public override int GetHashCode()
        {
            ...
            unchecked
            {
                return ((SceneAsset != null ? SceneAsset.GetHashCode() : 0) * 397) ^ (ScenePath != null ? ScenePath.GetHashCode() : 0);
            }
            #else
            unchecked
            {
        ...
        public static implicit operator SceneReference(in SceneAsset sceneAsset) 
            => new SceneReference() { SceneAsset = sceneAsset };
        ...
        public string GetSceneName
        {
            get
            {
        	    ...
        	    return System.IO.Path.GetFileNameWithoutExtension(path: scenePath);
