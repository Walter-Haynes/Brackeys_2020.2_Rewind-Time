...
namespace SCPE
{
    ...
    public class RenderPipelineInstallation
    {
        ...
        public const string MAX_LWRP_VERSION = "9.9.9.9"; //Not limited 

        public const string URP_PACKAGE_ID = "com.unity.render-pipelines.universal";
        public const string MIN_URP_VERSION = "7.2.0"; //Supports PPS
        public const string MAX_URP_VERSION = "9.9.9.9"; //Not limited 
        ...
        public static void UnpackURPFiles()
        {
            ...
            {
                Debug.LogError("URP script package with the GUID: " + guid + ". Could not be found in the project, was it changed or not imported? It should be located in <i>" + SCPE.PACKAGE_ROOT_FOLDER + "</i>");
                return;
            }
...
#endif
            //Negatives
#if !UNITY_2019_1_OR_NEWER // < 2019.1
            COMPATIBLE = false;
            UNTESTED = false;
#endif
#if UNITY_2020_2_OR_NEWER // >= 2020.2
            UNTESTED = true;
            COMPATIBLE = false;
#endif
